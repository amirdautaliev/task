                    ...
                    <div id="panel-1" class="panel">
                        ...
                        <div class="panel-container show">
                            ...
                            <?php foreach($images as $image): ?>
                                      ...
                                      <img src="<?php echo $image["image"];?>" width="352px">
                                            <a class="btn btn-danger" name="delete" href="task_18_delete.php?id=<?php echo $image["id"]; ?> panel-collapse" onclick="confirm('Вы уверены?');" >Удалить</a>
                                        </div>
                                           </form>
                                                <?php endforeach; ?>
                                    </div>
